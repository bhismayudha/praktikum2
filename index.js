const express = require("express") //memanggil library express jr
...
app.get("/test", (req,res) => {
    //req merupakan variable yang berisi data dan request
    //res merupakan variable yang berisi data response dari endpoint
